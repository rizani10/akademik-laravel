            ...
            <form action="/guru/{{ $guru->id }}" method="post">
                ...
                <div class="row">
                    <div class="col-lg-4 mt-3">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" placeholder="Nama" name="nama" value="{{ old('nama', $guru->nama) }}">
                        @error('nama')
                    ...
                    <div class="col-lg-4 mt-3">
                        ...
                        <input type="text" class="form-control @error('nuptk') is-invalid @enderror" id="nuptk" placeholder="NUPTK" name="nuptk" value="{{ old('nuptk', $guru->nuptk) }}">
                        @error('nuptk')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-lg-4 mt-3">
                        ...
                        <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" id="tanggal_lahir" placeholder="tanggal_lahir" value="{{ old('tanggal_lahir', $guru->tanggal_lahir) }}" name="tanggal_lahir">
                        @error('tanggal_lahir')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row mt-2">
                    <div class="col-lg-4 mt-3">
                        ...
                        <textarea name="alamat" id="alamat" cols="30" rows="2" class="form-control @error('alamat') is-invalid @enderror">{{ old('alamat', $guru->alamat) }}</textarea>
                        @error('alamat')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-4 mt-3">
                        ...
                        <select name="kepegawaian" id="kepegawaian" class="form-control @error('kepegawaian') is-invalid @enderror">
                            <option value="{{ $guru->kepegawaian }}" selected>{{ $guru->kepegawaian }}</option>
                ...
                <div class="row mt-2">
                    <div class="col-lg-6">
                        ...
                        <select name="jenis_ptk" id="jenis_ptk" class="form-control @error('jenis_ptk') is-invalid @enderror">
                            <option value="{{ $guru->jenis_ptk }}" selected>{{ $guru->jenis_ptk }}</option>
